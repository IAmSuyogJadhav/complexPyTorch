...
# Adapted from https://github.com/qubvel/segmentation_models.pytorch/blob/master/segmentation_models_pytorch/encoders/resnet.py
...
class ResNetEncoder(ResNet):
    ...
    def forward(self, xr, xi):
        ...
        for i in range(self._depth + 1):
            xr, xi = stages[i](xr, xi)
            features.append([xr, xi])

        return features

    def load_state_dict(self, state_dict, **kwargs):
        pass # Will have to figure out
